            ...
            <Card>
                <CardHeader>
                    <div class="flex items-center justify-between">
                        ...
                        <Link :href="`/admin/pet_owners/${petOwner.id}/edit`">
                            <Button>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <div class="text-lg font-semibold">{{ petOwner.name }}</div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="text-lg font-semibold">{{ petOwner.mobile_number || '—' }}</div>
                                </div>
                                    ...
                                    <CardContent class="pt-6">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p class="text-2xl font-bold">{{ petOwner.patients_count }}</p>
                                            </div>
                                    ...
                                    <CardContent class="pt-6">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p class="text-2xl font-bold">{{ petOwner.appointments_count }}</p>
                                            </div>
                                            <Badge variant="secondary" class="text-2xl">
                                                {{ petOwner.appointments_count }}
                                            </Badge>
                                        </div>
                                    </CardContent>
                                </Card>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <Link :href="`/admin/patients/create?user_id=${petOwner.id}`">
                                    <Button size="sm">
                                        Add Patient
                                    </Button>
                                </Link>
                            </div>
                            <div v-if="petOwner.patients.length > 0" class="overflow-x-auto">
                            ...
                            <div v-else class="text-center text-muted-foreground py-8">
                                No patients found. <Link :href="`/admin/patients/create?user_id=${petOwner.id}`" class="text-primary underline">Add a patient</Link>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t">
                            <div class="space-y-2">
                                ...
                                <div class="text-sm text-muted-foreground">
                                    {{ formatDateTime(petOwner.created_at) }}
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="text-sm text-muted-foreground">
                                    {{ formatDateTime(petOwner.updated_at) }}
                                </div>
                            </div>
                        </div>
                    </div>
