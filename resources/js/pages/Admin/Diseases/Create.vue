                ...
                <CardHeader>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <CardDescription>
                                Add a new disease with associated symptoms and medicines
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
                    ...
                    <Form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border rounded-md p-4 max-h-64 overflow-y-auto">
                                ...
                                <div v-if="symptoms.length === 0" class="text-sm text-muted-foreground text-center py-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border rounded-md p-4 max-h-64 overflow-y-auto">
                                ...
                                <div v-if="medicines.length === 0" class="text-sm text-muted-foreground text-center py-4">
