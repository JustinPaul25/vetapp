...
const breadcrumbs = [
    ...
    { title: 'My Prescriptions', href: '/prescriptions' },
...
const downloadPrescription = () => {
    window.open(`/prescriptions/${props.prescription.id}/download`, '_blank');
};

const printPrescription = () => {
    window.open(`/prescriptions/${props.prescription.id}/print`, '_blank');
};
</script>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="text-lg font-semibold">
                                        <Link :href="`/appointments/${appointment.id}`" class="text-blue-600 hover:underline">
                                            #{{ appointment.id }}
                                        </Link>
                                    </div>
                                </div>
